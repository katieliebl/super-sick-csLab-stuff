...
// This shows interactively how the 8-Queens problem can be solved
...
public class NQueens extends JFrame implements Runnable
{
		...
		public void actionPerformed(ActionEvent e)
		{
			if (e.getSource() == runDemo)
			{
				if (!paused)
				{
					...
					runThread = new Thread(NQueens.this);
					runThread.start();
				}
				else
				{
